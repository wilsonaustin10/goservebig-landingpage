...
const testimonials: Testimonial[] = [
  {
    name: "Jason & Mary",
    location: "Dallas, TX",
    text: "We needed to sell our house fast due to a job relocation. Go Big helped us with a fair cash offer and closed in just 8 days!",
    rating: 5
  },
  {
    name: "Robert Smith",
  ...
  },
  {
    ...
    text: "After trying to sell with a realtor for 6 months, I contacted Go Big Serve LLC. They closed quickly and even covered all closing costs!",
    rating: 5
  }
];
